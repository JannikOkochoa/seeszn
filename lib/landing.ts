...
export const LANDING_PAGES: Record<string, LandingPage> = {
  ...
  "ki-sichtbarkeit-agentur": {
    ...
    answer: {
      ...
      body: "Eine KI-Sichtbarkeit Agentur sorgt dafür, dass eine Marke nicht nur in klassischen Suchergebnissen rankt, sondern auch in KI-gestützten Antworten erscheint, etwa in ChatGPT, Perplexity, Gemini und Google AI Overviews. SEESZN verbindet dafür SEO, GEO und AIO zu einem System: technische Sucharchitektur, zitierfähige Inhalte und konsistente Entitäts- und Quellsignale.",
    },
    forWhom: {
  ...
  "chatgpt-sichtbarkeit": {
    ...
    faq: [
      ...
      { q: "Kann man garantieren, dass ChatGPT eine Marke empfiehlt?", a: "Nein. Niemand kontrolliert, in welcher Antwort eine Marke erscheint. Seriös ist: die Voraussetzungen verbessern, also Entitätsklarheit, Quellsignale, zitierfähige Inhalte. Wir bauen den Zustand, nicht den Trick." },
      ...
      { q: "Wie lange dauert es, in ChatGPT sichtbarer zu werden?", a: "Das hängt davon ab, wie oft Quellen aktualisiert oder neu erfasst werden und wie konsistent die Entität aufgebaut wird. Es ist ein aufgebauter Zustand, kein Schalter, und die Dauer variiert je nach Ausgangslage." },
    ],
    related: [
  ...
  "seo-agentur-bremen": {
    ...
    problem: {
      ...
      body: [
        "Viele etablierte Unternehmen sind in ihrer Region führend, aber online schwer auffindbar. Die Website bildet die Substanz nicht ab, die Suche findet sie nicht, KI-Systeme kennen sie nicht.",
    ...
    faq: [
      ...
      { q: "Was unterscheidet SEESZN von klassischen SEO-Agenturen?", a: "Wir behandeln SEO, GEO und AIO als ein System. Neben Rankings arbeiten wir an Zitierbarkeit in KI-Antworten, einem Bereich, den viele klassische Agenturen noch nicht abdecken." },

...
export const en = {
  ...
  diagnosisPage: {
    ...
    intakeForm: {
      headerLeft: "VISIBILITY DIAGNOSIS — INTAKE",
      intro: "No generic SEO audit. For B2B brands, founders and teams that already have demand, reputation or content — but are not yet visible in AI answers.",
      nameLabel: "FIELD 01 — NAME",
      nameOptional: "OPTIONAL",
      emailLabel: "FIELD 02 — EMAIL",
      emailRequired: "REQUIRED",
      brandLabel: "FIELD 03 — BRAND / WEBSITE",
      brandOptional: "OPTIONAL",
      marketLabel: "FIELD 04 — MARKET / LANGUAGE",
      marketOptional: "OPTIONAL",
      concernLabel: "FIELD 05 — MAIN CONCERN",
      concernOptional: "OPTIONAL",
      suspects: ["SEARCH RANKINGS", "AI ANSWERS", "WEBSITE", "CONVERSION", "UNKNOWN"],
      submitIdle: "REQUEST A DIAGNOSIS",
      submitLoading: "TRANSMITTING…",
      errorMessage: "TRANSMISSION FAILED. WRITE TO ",
      doneTitle: "REQUEST RECEIVED.",
      doneCopy: "We review your brand surface and respond with the most relevant next step — from hello@seeszn.com. A diagnosis, not a pitch.",
      footerLeft: "NO PITCH DECK. NO RETAINER TALK.",
      footerRight: "WE REVIEW & REPLY WITH THE NEXT STEP",
    },
    protocol: {

...
export const en = {
  ...
  aboutPage: {
    hero: {
      room: "ABOUT SEESZN",
      accession: "SZN-OM-04",
      roman: ["A SYSTEM FOR MEASURABLE"],
      italic: "growth decisions.",
      sub: [
        "SEESZN READS PUBLIC SIGNALS, IDENTIFIES THE STRONGEST",
        "EVIDENCE-BACKED CONSTRAINT AND SHIPS THE FIRST MOVE.",
        "THE RESULT IS MEASURED ACROSS A DEFINED WINDOW.",
      ],
      note: ["THIS PAGE DESCRIBES THE METHOD.", "THE READING OF YOUR SURFACE IS PRIVATE."],
      meta: "THE OPERATING MANUAL",
      cta: { label: "FIND MY FIRST MOVE", href: "/en/first-move" },
    },
    scanCta: {
      roman: "The method is public.",
      italic: "The reading is private.",
      sub: ["WE READ YOUR SURFACE BEFORE", "ANY IMPLEMENTATION BEGINS."],
      closing: "One constraint, one intervention, one documented result.",
    },
    manual: {
      premise: {
        label: "THE PREMISE",
        ...
        copy2: "WHAT FOLLOWS IS A PRODUCT INSTEAD OF A SERVICE MENU: ONE CONSTRAINT, ONE INTERVENTION, ONE DOCUMENTED RESULT.",
      },
      model: {
        label: "THE METHOD",
        rightLabel: "ONE MOVE · NO BUNDLE OF MEASURES",
        phases: [
          { name: "READ", desc: "Read the public signals across Search, AI Search and Google Ads." },
          { name: "PRIORITISE", desc: "Name the constraint with the widest gap between effort and result." },
          { name: "SHIP", desc: "Put exactly one bounded change live, with QA and one approval." },
          { name: "MEASURE", desc: "Fix the metric and its baseline up front, then document what moves." },
        ],
      },
      principles: {
        label: "PRINCIPLES",
      ...
      refusals: {
        ...
        items: [
          ...
          { name: "Growth language", gloss: "Nothing here is boosted, hyped or taken to the next level." },
        ],
      },
      unit: {
        label: "THE UNIT",
        ...
        copy1: "SEESZN IS OPERATED AS A SMALL, SENIOR-LED UNIT. READING, PRIORITISATION AND IMPLEMENTATION ARE HANDLED DIRECTLY BY THE PEOPLE ANSWERABLE FOR THE RESULT.",
        copy2: "NO ACCOUNT LAYERS. NO OUTSOURCED HANDOFFS. NO GENERIC AUDIT THEATRE.\nTHE PEOPLE WHO PRODUCE THE FINDING SHIP IT.",
        rolesLabel: "WHAT MEETS AT ONE TABLE",
        roles: [
          { name: "READING & PRIORITISATION", gloss: "Reading public signals and naming the constraint that explains the situation." },
          { name: "SEARCH & AI SEARCH", gloss: "Technical base, page logic and citable content for search and answer engines." },
          { name: "PAID ACQUISITION", gloss: "The account, the conversion path and the measurement signal behind paid traffic." },
          { name: "IMPLEMENTATION & QA", gloss: "The change goes live, checked and approved, with a documented before and after." },
        ],
  ...
  diagnosisPage: {
    ...
    result: {
      ...
      aiTeaserIntro: "We detected three questions where AI systems should name your brand.",
      ...
      gatePrivacy: "We use your details only for this analysis and our reply.",
      ...
      unlockError: "The analysis could not be sent. Please try again or write to ",

...
export const en = {
  ...
  diagnosisPage: {
    ...
    intakeForm: {
      ...
      ref: "SZN-VP-01",
      startQuestion: "Which brand should we check?",
      placeholder: "your-domain.com or brand name",
      startCta: "Start the check",
      trustNote: "No email needed. First we read your brand's surface.",
      ...
      loadingSteps: [
        ...
        "Loading the performance signal",
        "Building a first reading",
      ],
      findingLabel: "First reading:",
      gapsOne: "gap detected.",
      gapsMany: "gaps detected.",
    ...
    // Result cockpit — shown after the free check, before any email.
    result: {
      back: "New check",
      metaLabel: "Visibility check",
      fetchedLabel: "First reading",
      overallLabel: "Overall readiness",
      findingLabel: "First reading",
      scoresLabel: "Readiness scores",
      scoresNote: "Heuristic readiness from surface signals. Not a measurement of AI ranking.",
      ...
      reasonLabel: "Reading",
      stepLabel: "Next step",
      unlockHeadline: "Secure the full diagnosis",
      unlockCopy: "You'll get a personal reply with the most useful next step.",
      emailLabel: "Email",
      emailHint: "required",
      ...
      unlockCta: "Secure the diagnosis",
      unlockSending: "Sending…",
      unlockDoneTitle: "Diagnosis secured.",
      unlockDoneCopy: "We review the full surface and reply from hello@seeszn.com with the most useful next step.",

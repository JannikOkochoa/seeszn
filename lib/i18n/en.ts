...
export const en = {
  ...
  hero: {
    ...
    line2: "know your",
    italic: "brand.",
    sub: "SEESZN makes B2B brands visible in Google and in AI answers — ChatGPT, Perplexity, Gemini and AI Overviews. We build the visibility architecture that gets you found, cited and chosen.",
    cta: "CHECK BRAND VISIBILITY",
  },
  ...
  contact: {
    ...
    sub: "Send a domain and an email. We check where your brand appears, disappears or gets misread across Google and AI answers — ChatGPT, Perplexity, Gemini and AI Overviews. A diagnosis, not a pitch.",
  ...
  diagnosisPage: {
    ...
    protocol: {
      ...
      deliverables: [
        ...
        { name: "Priority actions", desc: "The highest-leverage moves, sequenced — and the recommended next step." },
      ],
    ...
    faqLabel: "QUESTIONS",
    faq: [
      { q: "What is a visibility diagnosis?", a: "A focused review of where your brand appears, disappears or gets misread across Google and AI answers — ChatGPT, Perplexity, Gemini and Google AI Overviews — ending with the most relevant next step." },

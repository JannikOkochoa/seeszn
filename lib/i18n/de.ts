...
export const de: Translations = {
  ...
  diagnosisPage: {
    ...
    intakeForm: {
      headerLeft: "SICHTBARKEITS-DIAGNOSE — INTAKE",
      intro: "Kein generisches SEO-Audit. Für B2B-Marken, Gründer und Teams, die bereits Nachfrage, Reputation oder Content haben — aber in KI-Antworten noch nicht sichtbar sind.",
      nameLabel: "FELD 01 — NAME",
      nameOptional: "OPTIONAL",
      emailLabel: "FELD 02 — E-MAIL",
      emailRequired: "PFLICHT",
      brandLabel: "FELD 03 — MARKE / WEBSITE",
      brandOptional: "OPTIONAL",
      marketLabel: "FELD 04 — MARKT / SPRACHE",
      marketOptional: "OPTIONAL",
      concernLabel: "FELD 05 — HAUPTANLIEGEN",
      concernOptional: "OPTIONAL",
      suspects: ["SEARCH RANKINGS", "AI ANSWERS", "WEBSITE", "CONVERSION", "UNBEKANNT"],
      submitIdle: "DIAGNOSE ANFRAGEN",
      submitLoading: "WIRD ÜBERTRAGEN…",
      errorMessage: "ÜBERTRAGUNG FEHLGESCHLAGEN. SCHREIB AN ",
      doneTitle: "ANFRAGE ERHALTEN.",
      doneCopy: "Wir prüfen deine Marken-Oberfläche und antworten mit dem relevantesten nächsten Schritt — von hello@seeszn.com. Eine Diagnose, kein Pitch.",
      footerLeft: "KEIN PITCH DECK. KEIN RETAINER-GESPRÄCH.",
      footerRight: "WIR PRÜFEN & ANTWORTEN MIT DEM NÄCHSTEN SCHRITT",
    },
    protocol: {

...
export const de: Translations = {
    ...
    rows: [
      {
        ...
        problem:
          "Du rankst bei Google — aber weißt nicht, ob ChatGPT, Perplexity, Gemini oder die AI Overviews deine Marke je nennen. Die meisten Marken sind in KI-Antworten unsichtbar und merken es nie.",
        work:
      ...
      },
      {
        ...
        gain: [
          ...
          "Seiten, die zitiert werden — nicht nur gelesen",
        ],
      },
      {
        num: "03",
  ...
  contact: {
    ...
    sub: "Eine Domain und eine E-Mail genügen. Wir prüfen, wo deine Marke in Google und in KI-Antworten — ChatGPT, Perplexity, Gemini, AI Overviews — auftaucht, verschwindet oder falsch gelesen wird. Eine Diagnose, kein Pitch.",
  ...
  diagnosisPage: {
    ...
    protocol: {
      ...
      deliverables: [
        ...
        { name: "Priorisierte Maßnahmen", desc: "Die wirksamsten Hebel, sequenziert — und der empfohlene nächste Schritt." },
      ],
    ...
    faqLabel: "FRAGEN",
    faq: [
      { q: "Was ist eine Sichtbarkeits-Diagnose?", a: "Eine fokussierte Prüfung, wo deine Marke in Google und KI-Antworten — ChatGPT, Perplexity, Gemini und Google AI Overviews — erscheint, verschwindet oder falsch verstanden wird — mit dem relevantesten nächsten Schritt." },

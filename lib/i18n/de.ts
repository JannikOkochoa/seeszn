...
export const de: Translations = {
  ...
  diagnosisPage: {
    ...
    intakeForm: {
      ...
      ref: "SZN-VP-01",
      startQuestion: "Welche Marke sollen wir prüfen?",
      placeholder: "deine-domain.de oder Markenname",
      startCta: "Prüfung starten",
      trustNote: "Keine E-Mail nötig. Erst lesen wir die Oberfläche deiner Marke.",
      ...
      loadingSteps: [
        ...
        "Quellsignale werden geprüft",
        "robots.txt wird geprüft",
        "sitemap.xml wird gesucht",
        "Antwortflächen werden erkannt",
        "Performance-Signal wird geladen",
    ...
    // Ergebnis-Cockpit — gezeigt nach der freien Prüfung, vor jeder E-Mail.
    result: {
      back: "Neue Prüfung",
      metaLabel: "Sichtbarkeitsprüfung",
      fetchedLabel: "Erste Lesung",
      overallLabel: "Gesamt-Readiness",
      findingLabel: "Erste Einordnung",
      scoresLabel: "Readiness-Werte",
      scoresNote: "Heuristische Readiness aus Oberflächensignalen. Keine Messung von KI-Rankings.",
      ...
      unlockHeadline: "Vollständige Diagnose sichern",
      unlockCopy: "Du erhältst eine persönliche Rückmeldung mit dem sinnvollsten nächsten Schritt.",
      emailLabel: "E-Mail",
      emailHint: "erforderlich",
      ...
      noteLabel: "Anliegen",
      noteHint: "optional",
      notePlaceholder: "Worum geht es konkret?",
      unlockCta: "Diagnose sichern",
      unlockSending: "Wird gesendet…",
      unlockDoneTitle: "Diagnose gesichert.",
      unlockDoneCopy: "Wir prüfen die vollständige Oberfläche und antworten von hello@seeszn.com mit dem sinnvollsten nächsten Schritt.",
      unlockError: "Konnte nicht senden. Schreib an ",
      reloading: "Prüfung wird wiederholt für",
      missingTitle: "Keine Lesung gefunden",

...
export const de: Translations = {
  ...
  aboutPage: {
    hero: {
      room: "ÜBER SEESZN",
      accession: "SZN-OM-04",
      roman: ["EIN SYSTEM FÜR MESSBARE"],
      italic: "Wachstumsentscheidungen.",
      sub: [
        "SEESZN PRÜFT ÖFFENTLICHE SIGNALE, PRIORISIERT DEN",
        "STÄRKSTEN BELEGBAREN ENGPASS UND SETZT DEN FIRST MOVE UM.",
        "DER EFFEKT WIRD ÜBER EINEN DEFINIERTEN ZEITRAUM DOKUMENTIERT.",
      ],
      note: ["DIESE SEITE BESCHREIBT DAS VERFAHREN.", "DIE LESUNG DEINER OBERFLÄCHE BLEIBT PRIVAT."],
      meta: "THE OPERATING MANUAL",
      cta: { label: "FIRST MOVE", href: "/first-move" },
    },
    scanCta: {
      roman: "Das Verfahren ist öffentlich.",
      italic: "Die Lesung ist privat.",
      sub: ["WIR LESEN DEINE OBERFLÄCHE, BEVOR", "IRGENDEINE UMSETZUNG BEGINNT."],
      closing: "Ein Engpass, eine Umsetzung, ein dokumentiertes Ergebnis.",
    },
    manual: {
      premise: {
        label: "DAS FUNDAMENT",
        ...
        copy2: "DARAUS FOLGT EIN PRODUKT UND KEIN LEISTUNGSKATALOG: EIN ENGPASS, EINE UMSETZUNG, EIN DOKUMENTIERTES ERGEBNIS.",
      },
      model: {
        label: "DAS VERFAHREN",
        rightLabel: "EIN MOVE · KEIN MASSNAHMENPAKET",
        phases: [
          { name: "PRÜFEN", desc: "Öffentliche Signale aus Search, AI Search und Google Ads lesen." },
          { name: "PRIORISIEREN", desc: "Den Engpass mit der größten Lücke zwischen Aufwand und Ergebnis benennen." },
          { name: "UMSETZEN", desc: "Genau eine begrenzte Änderung live bringen, mit QA und einer Freigabe." },
          { name: "MESSEN", desc: "Messgröße und Basiswert vorher festlegen, danach den Verlauf dokumentieren." },
        ],
      },
      principles: {
        label: "PRINZIPIEN",
      ...
      unit: {
        ...
        copy1: "SEESZN WIRD ALS KLEINE, SENIOR GEFÜHRTE EINHEIT BETRIEBEN. PRÜFUNG, PRIORISIERUNG UND UMSETZUNG LIEGEN DIREKT BEI DEN PERSONEN, DIE FÜR DAS ERGEBNIS VERANTWORTLICH SIND.",
        copy2: "KEINE ACCOUNT-SCHICHTEN. KEINE AUSGELAGERTEN ÜBERGABEN. KEIN GENERISCHES AUDIT-THEATER.\nWER DEN BEFUND ERHEBT, SETZT IHN AUCH UM.",
        rolesLabel: "WAS AN EINEM TISCH ZUSAMMENKOMMT",
        roles: [
          { name: "PRÜFUNG & PRIORISIERUNG", gloss: "Öffentliche Signale lesen und den Engpass benennen, der die Situation erklärt." },
          { name: "SEARCH & AI SEARCH", gloss: "Technische Basis, Seitenlogik und zitierfähige Inhalte für Suche und Answer Engines." },
          { name: "PAID ACQUISITION", gloss: "Konto, Konversionspfad und Messsignal hinter bezahltem Traffic." },
          { name: "UMSETZUNG & QA", gloss: "Die Änderung geht live, geprüft und freigegeben, mit dokumentiertem Vorher/Nachher." },
        ],
  ...
  diagnosisPage: {
    ...
    result: {
      ...
      aiTeaserIntro: "Wir haben drei Fragen erkannt, bei denen KI-Systeme deine Marke nennen müssten.",
      ...
      gatePrivacy: "Wir nutzen deine Angaben nur für diese Auswertung und unsere Rückmeldung.",
      ...
      unlockError: "Die Analyse konnte nicht gesendet werden. Bitte versuche es erneut oder schreibe an ",
      rateLimited: "Zu viele Anfragen. Bitte versuche es in wenigen Minuten erneut.",

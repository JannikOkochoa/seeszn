...
const de = {
  ...
  backlinks: {
    ...
    unitNote: "Der Stückpreis sinkt mit jeder weiteren Platzierung.",
    billingLabel: "Abrechnung",
    once: "EINMALIG",
    monthly: "MONATLICH",
    monthlySave: "CA. 10 % GÜNSTIGER",
    minTerm: (m: number) => `MINDESTLAUFZEIT · ${m} MONATE`,
    minCommitment: (v: string) => `MINDESTBINDUNG · ${v} NETTO`,
    savingNote: (v: string) => `Spart ${v} pro Monat gegenüber Einmalkauf`,
    ...
    questions: [
      { q: "Was kostet ein Backlink?", a: "Der Stückpreis liegt zwischen 19,80 € und 14,45 € netto und sinkt mit jeder weiteren Platzierung. Einmalig kosten 5 Platzierungen 99 €, 100 Platzierungen 1.599 €. Monatlich beginnt die Staffel bei 10 Platzierungen für 162 € im Monat." },
      { q: "Kann ich genau 17 Backlinks bestellen?", a: "Ja. Wählbar ist jede ganze Menge von 5 bis 100 bei Einmalbestellungen, von 10 bis 100 bei Monatsplänen. Also auch 6, 17 oder 43. Der Stückpreis sinkt dabei auf jeder ganzen Zahl." },
      ...
      { q: "Wie lange läuft ein Monatsplan?", a: "Monatspläne haben eine Mindestlaufzeit von drei Monaten. Monatspreis und Mindestbindung stehen vor dem Checkout, nicht erst in den Bedingungen. Bei 20 Platzierungen im Monat sind das 320 € monatlich und 960 € netto Mindestbindung." },
  ...
  review: {
    ...
    commitment: (m: number, v: string) => `Mindestbindung über ${m} Monate · ${v} netto`,
...
const en: typeof de = {
  ...
  backlinks: {
    ...
    unitNote: "The unit price falls with every additional placement.",
    billingLabel: "Billing",
    once: "ONE TIME",
    monthly: "MONTHLY",
    monthlySave: "APPROX. 10% LOWER",
    minTerm: (m: number) => `MINIMUM TERM · ${m} MONTHS`,
    minCommitment: (v: string) => `MINIMUM COMMITMENT · ${v} NET`,
    savingNote: (v: string) => `Saves ${v} per month against a one time order`,
    ...
    questions: [
      { q: "How much does a backlink cost?", a: "The unit price runs from €19.80 down to €14.45 net, falling with every additional placement. One time, 5 placements cost €99, 100 placements cost €1,599. Monthly plans start at 10 placements for €162 per month." },
      { q: "Can I order exactly 17 backlinks?", a: "Yes. Every whole quantity from 5 through 100 is selectable for one time orders, 10 through 100 for monthly plans. That includes 6, 17, 43. The unit price falls at every single step." },
      ...
      { q: "How long does the monthly plan run?", a: "Monthly plans have a minimum term of three months. The monthly price plus the minimum commitment are shown before checkout, not buried in the terms. At 20 placements per month that is €320 monthly, €960 net committed." },
  ...
  review: {
    ...
    commitment: (m: number, v: string) => `Committed over ${m} months · ${v} net`,
